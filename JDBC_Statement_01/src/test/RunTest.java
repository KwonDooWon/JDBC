...
public class RunTest {
	...
	public static void main(String[] args) {
		/*
	       ...
	       * 
	       * 6_1) ResultSet에 담겨있는 데이터들을 하나씩 하나씩 뽑아서 vo객체에 차근차근 옴겨담기[+ ArrList에 담아주기] 
	       * 6_2)트렌잭션 처리 (성공했다면 commit, 실패했다면 rollback 실행)
	       * 
	       * 7) 다 사용한 JDBC용 객체를 반드시 지원 반납(close) => 생성된 역순으로
	       * 
	       */
	      ...
	      */
	      ...
	      try {
	         ...
	         while(rset.next()) {
	        	 // 현재 참조하는 rset으로부터 어떤 컬럼에해당하는 값을 어떤타입으로 뽑을건지 제시해줘야한다.
